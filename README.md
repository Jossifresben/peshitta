...
- **Semantic bridges** — 589 cross-root connections showing how an outlier word's meaning belongs to another root family (click to expand in visualizer)
...
- **589** semantic bridges across 436 root families
